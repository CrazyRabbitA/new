<template>
  <div role="dialog" v-bind:class="{
    ...
    <div class="modal-dialog" role="document" v-bind:style="{width: '50%'}">
      <div class="modal-content">
        <slot name="modal-header" v-if="type !== 'message'">
          <div class="modal-header">
            <i class="iconhandle close" @click.stop="close">&#xe609;</i>
...
<script>
/* eslint-disable */
import getScrollBarWidth from '../../../../components/utils/getScrollBarWidth.js';
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              if (dialogHeight > windowHeight) {
                ...
                if ((windowHeight - dialogHeight) / 2 > 50) {
                  dialogBox.style.top =
                    (windowHeight - dialogHeight) / 2 - 50 + 'px';
                } else {
                  dialogBox.style.top =
                    (windowHeight - dialogHeight) / 2 + 'px';
                }
              }
