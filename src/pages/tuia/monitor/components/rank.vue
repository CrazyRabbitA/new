    ...
    <template slot="modal-body">
      ...
      <span class="top-rank-type-wrap">
        ...
        <div class="top-rank-type">
          ...
          <span v-if="showAdv" class="adv-type" :class="{'active': advRankType}" @click="getCurrentRank('advRank')">广告</span>
          <span v-if="showSlot" class="slot-type" :class="{'active': slotRankType}" @click="getCurrentRank('slotRank')">广告位</span>
          <span v-if="showAct" class="act-type" :class="{'active': actRankType}" @click="getCurrentRank('actRank')">活动</span>
        </div>
      </div>
      <template v-if="currentRank === 'advRank'">
        <adv-rank :quota-type="quotaType" :select-day="selectDay" :act-id="actId" :app-id="appId" :slot-id="slotId"  :loadshow.sync="loadshow"></adv-rank>
      </template>
      <template v-if="currentRank === 'appRank'">
        <app-rank :quota-type="quotaType" :select-day="selectDay" :act-id="actId" :app-id="appId" :slot-id="slotId" :source-type="sourceType" :loadshow.sync="loadshow"></app-rank>
      </template>
