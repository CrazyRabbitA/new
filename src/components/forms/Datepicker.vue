<template>
  <div class="datepicker">
    ...
    <span class="iconhandle-del-warp">       
      <i class="iconhandle iconhandle-del" :class="{ 'iconhandle-has-value': value}" v-if="value">
        <span class="sel-time">&#xe60d;</span>
        <span class="del-time" @click="deleteTime">&#xe61d;</span>
      </i>
      <i class="iconhandle" :class="{ 'iconhandle-has-value': value}"  v-else @click="inputClick">&#xe60d;</i>
    </span>
    <div class="datepicker-popup" v-show="displayDayView">
      <div class="datepicker-inner">
        <div class="datepicker-body">
          <div class="datepicker-ctrl">
            <span class="month-btn datepicker-preBtn iconhandle" @click="preNextMonthClick(0)">&#xe642;</span>
            <span class="month-btn datepicker-nextBtn iconhandle" @click="preNextMonthClick(1)">&#xe643;</span>
          ...
          <div class="datepicker-monthRange">
            <template v-for="m in text.months">
              <span :class="{'datepicker-dateRange-item-active':
                  (this.text.months[this.getTimeMonth(this.value)] === m) &&
        ...
        <div class="datepicker-body">
          ...
          <div class="datepicker-monthRange decadeRange">
            <template v-for="decade in decadeRange">
              <span :class="{'datepicker-dateRange-item-active':
                  this.getTimeYear(this.value) === decade.text}"
  ...
  methods: {
    ...
    getTimeRange() {
      ...
      for (let i = 0; i < 24; i++) {
        ...
        let sclass = ''
        if (this.timeflag && isSameDay(this.tempDate, now) && currHour > i) {
    ...
    getMinuteRange() {
      ...
      for (let i = 0; i <= 55; i += 5) {
        ...
        if (this.timeflag && isSameDay(this.tempDate, now) && currMinute >= i && currHour === +this.tempTime) {
          sclass = 'datepicker-item-disable'
        }
